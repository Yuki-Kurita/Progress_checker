        ...
        case 'message':
            ...
            switch ($message['type']) {
                case 'text':
                    ...
                    else if($_SESSION['addSecondFlag']){
                    ...
                    // タスク編集時の処理4
                    else if($_SESSION['editThirdFlag']){
                      // 編集のキャンセル
                      if(strpos($message['text'],'やめる')!==false){
                    ...
                    // タスク編集時の処理3
                    else if($_SESSION['editSecondFlag']){
                      // 編集のキャンセル
                      if(strpos($message['text'],'やめる')!==false){
                    ...
                    // 進捗報告の時の処理3
                    else if($_SESSION['progSecondFlag']){
                      if(strpos($message['text'],'やめる')!==false){
                    ...
                    // タスク追加の時の処理1
                    else if(strpos($message['text'],'追加')!==false){
                      $reply->setMessage('タスクを追加するね！タスク名を入力してね！'."\n".'追加をやめたい場合 :「やめる」'."\n".'と入力してね！');
                      $reply->replyAuto($client,$event);
                      $_SESSION['addFlag'] = true;
                    }
                    // タスク確認処理1
                    else if(strpos($message['text'],'確認')!==false){
